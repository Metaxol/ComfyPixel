...
public class Utility : MonoBehaviour {
    ...
    protected void run_text(List<string> lines, Text text_box, float scroll_speed) ///default input is e
    {
        if (can_scroll)
        {
    ...
    private void options_choosing(int stop, string hor_ver) ///default value for start is 0
    {
